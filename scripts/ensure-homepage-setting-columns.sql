...
ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS tiktok_url TEXT;
ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS instagram_url TEXT;
ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS team_tiktok_url TEXT;
ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS team_instagram_url TEXT;
